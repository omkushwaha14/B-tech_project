...
const Orders = () => {
  ...
  const showOrdersLength = () => {
    if (orders.length > 0) {
      return <h5 className="text">Total orders: {orders.length}</h5>;
    }
  };
              ...
              return (
                <div>
                  <div
                    ...
                    role="alert"
                    style={{ padding: "20px", border: "3px solid blue" }}
                  >
                  ...
                  <ul className="list-group mb-2">
                    ...
                    <li className="list-group-item">Name: {o.address}</li>
                    <li className="list-group-item">Phone number: {o.phone}</li>
                    <li className="list-group-item">
                      Delivery address: {o.exactaddress}
                    </li>
                  </ul>

                  <h6>Total products in the order: {o.products.length}</h6>
